...
const BETA_LANGUAGE_NOTES: Partial<Record<LanguageCode, string>> = {
	...
	gu: "પૂર્વાવલોકન રિલીઝ: ભાષા અનુવાદ સુવિધાનું પરીક્ષણ ચાલી રહ્યું છે. તેમાં કેટલીક ભૂલો હોઈ શકે છે.",
	...
	as: "বেটা ৰিলিজ: ভাষা অনুবাদ পৰীক্ষাধীন। কিছুমান ভুল থাকিব পাৰে।",
	mai: "बीटा रिलीज: भाषा अनुवाद परीक्षणमे अछि। किछु त्रुटि भ' सकैत अछि।"
};
